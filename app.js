new Vue({
    ...
    data: {
        ...
        game_is_on: false,
        attack_multiple: 10,
        spacial_attack_multiple: 25,
        heal_up_multiple: 20,
        monster_attack_multiple: 25,
        log_text: {
            attack: "Oyuncu saldırısı : ",
            spacial_attack: "Özel oyuncu saldırısı : ",
    ...
    methods: {
        ...
        spacial_attack: function () {
            var point = Math.ceil(Math.random() * this.spacial_attack_multiple);
            this.monster_heal -= point;
            this.add_to_log({ turn: "p", "text": this.log_text.spacial_attack + point });
            this.monster_attack();
        },
        heal_up: function () {
